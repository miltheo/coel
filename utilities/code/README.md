...
- `COEL_model_csv_to_json.R` converts model registry CSV files into derived JSON serialisations.
...
- `COEL_json_builder.R` builds COEL Behavioural Atom JSON from classified event data.
- `COEL_bin_to_Atoms.R` contains GENEAcore-dependent preparation helpers for local source data.
