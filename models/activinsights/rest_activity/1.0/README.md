...
This model is provided as an implementation-specific behaviour classification resource within the COEL v2.0 ecosystem and supports validation, mapping, and interoperability workflows.
...
- Related mappings to COEL Model v2.0 are available in the repository mapping folder.
