...
- JSON-LD and other semantic resources are maintained separately from the Atom v2.0 JSON Schema.
- Private evaluation payloads and source-derived payload exports are not included in the public release.
